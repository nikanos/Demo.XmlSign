...
# we also specify the Microsoft Enhanced RSA and AES Cryptographic Provider to support the newer hashing algorithms that are required in the new versions of .NET Framework (see https://learn.microsoft.com/en-us/powershell/module/pki/new-selfsignedcertificate?view=windowsserver2022-ps)
